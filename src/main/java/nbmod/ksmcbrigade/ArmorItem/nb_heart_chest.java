...
public class nb_heart_chest extends ArmorItem {
    public nb_heart_chest(ArmorMaterial armorMaterial, EquipmentSlot slot, Settings settings) {
    ...
    public void inventoryTick(ItemStack stack, World world, Entity entity, int slot, boolean selected) {
        ...
        entity1.addStatusEffect(new StatusEffectInstance(StatusEffects.WATER_BREATHING,999999999,255,false,false));
